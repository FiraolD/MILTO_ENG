export const BRAND = {
    ...
    description: "Ethiopia's trusted Grade One Water Resources consulting and engineering firm, delivering professional services in water resources, groundwater, hydrogeology, geophysics, geotechnical investigation, environmental services, GIS/remote sensing, and engineering consulting since 2021.",
    year: 2021,
    founded: "2021",
...
export const SERVICES = [
    {
        ...
        description: "Comprehensive water resources assessment, planning, and management including surface water hydrology, dam and reservoir engineering, and irrigation system design.",
        icon: "Drop",
        details: [
    ...
    },
    {
        ...
        description: "Expert groundwater exploration, assessment, and development services using advanced hydrogeological techniques and modeling.",
        icon: "WaveTriangle",
        details: [
    ...
    },
    {
        ...
        description: "Advanced geophysical surveys and geotechnical investigations for infrastructure, water resources, and construction projects.",
        icon: "CompassTool",
        details: [
    ...
    },
    {
        ...
        description: "Integrated environmental assessment, impact studies, and management solutions for sustainable development projects.",
        icon: "Leaf",
        details: [
    ...
    },
    {
        ...
        description: "State-of-the-art spatial analysis, remote sensing, and geographic information systems for informed decision-making.",
    ...
    },
    {
        ...
        description: "Comprehensive engineering consulting services spanning feasibility studies, design, supervision, and project management.",
        icon: "GearSix",
        details: [
...
export const PROJECTS = [
    {
        ...
        description: "Comprehensive groundwater resource assessment of the Rift Valley Basin, including aquifer characterization, water quality analysis, and sustainable yield estimation for 15 woredas.",
        images: [],
    },
    {
        id: "project-2",
        ...
        description: "Feasibility study and detailed design for expansion of water supply infrastructure serving 500,000 residents, including reservoir design, transmission mains, and distribution network optimization.",
        images: [],
    },
    {
        id: "project-3",
        ...
        year: "2022-2023",
        category: "Water Resources",
        description: "Irrigation development master plan covering 25,000 hectares, including water availability assessment, canal system design, and environmental and social management framework.",
        images: [],
    },
    {
        id: "project-4",
        ...
        description: "Subsurface geotechnical investigation for 120 km highway corridor, including borehole drilling, soil testing, seismic surveys, and foundation recommendations for 12 major bridge structures.",
        images: [],
    },
    {
        id: "project-5",
        ...
        description: "Environmental Impact Assessment and management plan for integrated watershed management project, addressing water quality, ecosystem conservation, and community livelihood sustainability.",
        images: [],
    },
    {
        id: "project-6",
        ...
        year: "2023-2024",
        category: "GIS",
        description: "Development of web-based GIS platform for urban water supply infrastructure management, integrating asset mapping, customer management, and leak detection analytics for 8 municipalities.",
        images: [],
    },
];
...
export const VALUES = [
    {
        ...
        description: "We deliver solutions grounded in rigorous science, advanced engineering, and continuous innovation.",
    },
    {
        title: "Integrity & Ethics",
        description: "We uphold the highest standards of professional ethics, transparency, and accountability in all engagements.",
    },
    {
        title: "Sustainability",
        description: "We integrate environmental stewardship and social responsibility into every project we undertake.",
    },
    {
        title: "Client Partnership",
        description: "We build lasting relationships through collaborative engagement, responsiveness, and tailored solutions.",
    },
];
